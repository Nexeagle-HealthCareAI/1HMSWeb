            ...
            <div className="min-h-full grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="hidden lg:flex flex-col items-center justify-start min-w-[220px] h-full p-0">
                <div className="w-full bg-gradient-to-b from-blue-50 to-blue-100 rounded-t-lg px-6 pt-7 pb-4 flex flex-col items-center text-center border-b border-blue-200">
                  <div className="text-lg font-semibold text-blue-900 mb-1">Prescription Actions</div>
                  <div className="text-xs text-blue-700 mb-2">Download, share, or print your prescription PDF. These options help you keep, send, or use your prescription as needed.</div>
                  <div className="text-[11px] text-blue-500">Tip: For best print results, use A4 paper and set margins to minimum.</div>
                </div>
