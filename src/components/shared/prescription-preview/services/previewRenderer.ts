...
export const buildTemplateBoundPreview = async ({ templateFile, layout, typography, payload, printFields, appointmentDate }: TemplateBoundPreviewOptions) => {
  ...
  // (see mapTemplateToPreviewConfig) — do not add them together, that double-counts the header/
  // footer height and can push all clinical content off page 1 on a real branded template.
