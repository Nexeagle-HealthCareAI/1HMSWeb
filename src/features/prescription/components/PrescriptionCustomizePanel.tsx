        ...
        {customizeTab === 'fields' ? (
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex flex-col sm:flex-row gap-3 sm:gap-4 overflow-visible">
              {/* Category picker: dropdown on mobile, vertical sidebar list on desktop */}
              <div className="sm:hidden flex-shrink-0">
                <Select value={selectedPersonalizedCategory} onValueChange={setSelectedPersonalizedCategory}>
              ...
              <div className="hidden sm:flex w-64 flex-shrink-0 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-3 min-h-0 bg-white dark:bg-gray-900">
                    ...
                    {personalizedDataCategories.map((category) => {
                      ...
                      return (
                        <button
                          ...
                          className={`group w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 relative overflow-hidden ${isSelected
                        ...
                        >
                          ...
                          <span className="whitespace-normal truncate">{category.label}</span>
                        </button>
                      );
                    })}
                  </div>
