...
import { UserManagement } from '@/features/hospital/components/UserManagement';
import { PatientsPage } from '@/features/patient/components/PatientsPage';
...
export const AdminDashboard = () => {
  ...
  console.log('Setup data exists:', false); // TODO: Move to Zustand store
  console.log('Setup completed:', false); // TODO: Move to Zustand store
