...
/**
 * DEV-ONLY mobile-review gallery for the IPD screens.
 *
...
const SCREENS: { title: string; path: string; note: string }[] = [
        ...
        <div className="min-h-screen bg-slate-900 text-white">
            <div className="max-w-[1600px] mx-auto px-6 py-8">
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
                    <div>
                        <h1 className="text-2xl font-black tracking-tight">IPD — Mobile Review</h1>
                        <p className="text-slate-400 text-sm mt-1 max-w-2xl">
                            Every screen below is rendered at a real phone width with dummy data — this is exactly how it
                            looks on a mobile device. Scroll inside a phone to explore; the Admit Patient wizard is tappable
                            through all 4 steps.
                        </p>
                    </div>
