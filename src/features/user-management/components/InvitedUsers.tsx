...
export const InvitedUsers: React.FC = () => {
  const { getInvitedUsers } = useUserManagementApi();
  const { data: users = [], isLoading, error } = getInvitedUsers();
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-muted-foreground">Loading invited users...</div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-red-600">Error loading invited users</div>
      </div>
    );
  }
                ...
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        ...
                        {isExpired(user.expiresAt) && user.status === 'pending' && (
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full lg:w-auto">
                    ...
                    <div className="flex gap-1">
                      ...
                      {user.status === 'pending' && !isExpired(user.expiresAt) && (
                        <Button variant="ghost" size="sm">
