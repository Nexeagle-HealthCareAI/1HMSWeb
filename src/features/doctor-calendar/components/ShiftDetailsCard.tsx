...
export const ShiftDetailsCard: React.FC = () => {
  return (
    <Card className="h-fit bg-white shadow-md border border-gray-200 lg:max-w-xs">
      ...
      <CardContent className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h4 className="text-xs font-medium text-gray-900">Default Shifts</h4>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h4 className="text-xs font-medium text-gray-900">Personalized</h4>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h4 className="text-xs font-medium text-gray-900">Unavailable</h4>
        ...
        <div className="pt-2 border-t border-gray-200">
          <h5 className="text-xs font-medium text-gray-900 mb-2">Color Legend</h5>
