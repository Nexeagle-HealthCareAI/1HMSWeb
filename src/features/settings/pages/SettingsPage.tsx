  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-6 lg:p-8 pb-24 max-md:pb-28">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Premium Android UI Compatible Header Bar (Desktop Only) */}
        <div className="hidden lg:flex flex-col lg:flex-row lg:items-center justify-between gap-3 rounded-2xl border border-white/40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl px-4 py-3 shadow-lg shadow-brand-500/5 ring-1 ring-black/5">
